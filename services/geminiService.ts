...
export const addAccessoryToImage = async (modelImageUrl: string, accessoryImage: File): Promise<string> => {
    const modelImagePart = dataUrlToPart(modelImageUrl);
...
**Crucial Rules:**
1.  **Preserve Everything:** The person's existing clothing, face, hair, body shape, pose, and the entire background from the 'model image' MUST remain unchanged.
2.  **Add the Accessory:** Realistically add the accessory onto the person. It should fit naturally and adapt to their pose with correct perspective, shadows, and lighting consistent with the original scene.
3.  **Output:** Return ONLY the final, edited image. Do not include any text.`;
