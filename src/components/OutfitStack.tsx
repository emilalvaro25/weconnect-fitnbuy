    ...
    <div className="flex flex-col">
      <div className="flex items-center justify-between border-b border-gray-400/50 pb-2 mb-3">
        ...
        <button
          ...
          disabled={outfitHistory.length <= 1}
          className="flex items-center gap-1.5 text-sm font-semibold text-gray-700 bg-gray-100 px-3 py-1.5 rounded-md hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
